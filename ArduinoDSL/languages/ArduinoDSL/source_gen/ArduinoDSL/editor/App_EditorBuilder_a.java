...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.init_state$$A7K;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.init_state$$A7K);
    ...
    provider.setNoTargetText("<no init_state>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.init_state$$A7K);
    }
  ...
  private static class bricksListHandler_g38wqt_b2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.bricks$vyGh;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Brick$6T;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(bricksListHandler_g38wqt_b2a.this.getNode(), LINKS.bricks$vyGh));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new stateListHandler_g38wqt_b4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class stateListHandler_g38wqt_b4a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public stateListHandler_g38wqt_b4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.state$FiRM;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.State$Cs;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(stateListHandler_g38wqt_b4a.this.getNode(), LINKS.state$FiRM));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Brick$6T = MetaAdapterFactory.getConcept(0x3e84098b58f348f4L, 0x85d9fe67fc1ba374L, 0xddcad4713a3df90L, "ArduinoDSL.structure.Brick");
    /*package*/ static final SConcept State$Cs = MetaAdapterFactory.getConcept(0x3e84098b58f348f4L, 0x85d9fe67fc1ba374L, 0x72062f1503ac8585L, "ArduinoDSL.structure.State");
  }
